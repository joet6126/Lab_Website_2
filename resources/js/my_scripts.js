...
function loadStatsPage()
{
	...
	{//Outer for loop iterates over each row
		...
		{
			table.rows[row_counter].cells[4].innerHTML = "University of Colorado at Boulder";
			wins++;
		}
		else
		{
		...
		wintable.innerHTML = wins;
		losstable.innerHTML = losses;
	}
...
*/
		function loadPlayersPage()
		{
			...
			selector.innerHTML = '<a href="#" onclick="switchPlayers(1)">' + players[0].name + '</a><br><a href="#" onclick="switchPlayers(2)">' + players[1].name +  '</a><br><a href="#" onclick="switchPlayers(3)">' + players[2].name +  '</a><br><a href="#" onclick="switchPlayers(4)">' + players[3].name +  '</a>';
		}
/*
...
*/
		function switchPlayers(playerNum)
		{
			...
			var p_image = document.getElementById("player_img");
			p_image.alt = player.alt;
			p_image.src = player.img;
